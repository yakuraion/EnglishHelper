...
import pro.yakuraion.englishhelper.data.repositories.DatabaseUpdateRepositoryImpl
...
internal interface RepositoriesModule {
    ...
    @Singleton
    @Binds
    fun bindsDatabaseInfoRepository(impl: DatabaseUpdateRepositoryImpl): DatabaseUpdateRepository
